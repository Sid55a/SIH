                ...
                <tr className="border-b border-gray-200 hover:bg-gray-100">
                  ...
                  <td className="py-3 px-6 text-center">
                    <select
                      ...
                      className={`rounded-xl font-semibold text-gray-600 p-2`}
                    >
                      <option value="pending" className=" bg-lime-100">
                        Pending
                      </option>
                      <option value="viewed" className=" bg-lime-100">
                        Viewed
                      </option>
                      <option value="resolved" className=" bg-lime-100">
                        Resolved
                      </option>
                    </select>
